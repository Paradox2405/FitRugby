...
class SelectedWorkoutPage extends GetView<SelectedWorkoutController> {
  const SelectedWorkoutPage({Key? key}) : super(key: key);
            ...
            children: [
                    ...
                    children: [
                      ...
                      Expanded(
                        child: ListView.builder(
                            ...
                            shrinkWrap: true,
                            itemCount: mainDataSet[dataItem].subCategory.length,
              ...
              Container(
                ...
                child: ElevatedButton(
                  onPressed: () => {
                    controller.startWorkout(mainDataSet[dataItem].day,dataItem),
                  },
                  child: TextField(
